-- Emergency service material costs


-- ALTER VIEW Z_Report_Emergency_service_material_costs_1yr AS
SELECT
	h.PO_number
	--,l.PO_number
	,h.Date_document
...
WHERE
	...
	AND l.Cost_type = 2
	AND h.Date_document > GetDate() - 365					-- Limits to last year of data
